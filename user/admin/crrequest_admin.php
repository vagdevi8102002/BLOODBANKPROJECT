        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crrequest_admin.php?page=0" class="nav-link dropdown-toggle"><i class="fa fa-laptop me-2"></i>Current Requests</a>
                ...
                <div class="bg-secondary text-center rounded p-4 pagination">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                              <?php
                                  $sql = "SELECT * FROM requestblood WHERE status = 0 limit ".$_GET['page'].", 5";
                               ...
                               ?>
                                <!-- <tr>
                                    ...
                                    <td>6396210439</td>
                                    <td>Delhi</td>
                                    <! <td><button class="btn btn-sm btn-primary" onClick="fun(>)">Detail</button></td> -->
                                </tr>
                            </tbody>
                        </table>
                    </div>
